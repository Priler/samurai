...
strings = {
    ...
    "ru": {
        ...
        "announcements" : (
            ...
            {
                "message" : "<b>⛩ Я - бот Самурай!</b>\n\nЯ слежу в чате за порядком и смотрю чтобы ты общался вежливо.\nКак и у других самураев, у меня есть катана!\n\nА еще у меня есть <u>открытый исходный код</u>, вот он - https://github.com/Priler/samurai",
                "every" : 14400
            }
        )
    },
