...
strings = {
    "en": {
        ...
        # Bot will react to short messages with these words
        "greetings_words": ("hi", "q", "hello", "hey")
    },
    "ru": {
        ...
        # Бот среагирует на короткие сообщения с этими словами
        "greetings_words": ("привет", "хай", "ку", "здарова"),
...
def get_string(key):
    ...
    if localization_strings is None:
        raise KeyError(
            f'Neither "{config.bot.language}" nor "en" locales found')
