...
class GenderDetectionTests(unittest.TestCase):
    ...
    def test_female(self):
        test_names = ["Васюша", "Стасенька", "Стася", "👧 Александра", "Катя", "Ксения", "Ксюша", "Антонина", "Настя", "👧👧Лиза👧👧", "Ника", "Лея", "Алиска", "Катерина Лися", "Софа Макаревич", "Есения Заплачу первому", "Лея 🧡", "Стася", "Оляша"]
        for name in test_names:
            with self.subTest(name=name):
