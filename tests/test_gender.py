...
class GenderDetectionTests(unittest.TestCase):
    ...
    def test_female(self):
        test_names = ["Юлианна", "Юлиана", "Тина (➡️ посмотри проф)", "Инесса", "Инеса", "Hasтюшкаааа",
                      "Даша (посмoтри профuль)", "Нина ( загляни в проф)", "Ясмина Дубинина", "Яся (пocмoтpu пpoφиль)",
                      "Жасмин Калачева", "Васюша", "Стасенька", "Злата (посмотри био)",
                      "Стася", "👧 Александра", "Катя", "Ксения", "Ксюша", "Антонина",
                      "Настя", "👧👧Лиза👧👧", "Ника", "Лея", "Алиска",
                      "Катерина Лися", "Софа Макаревич", "Есения Заплачу первому", "Лея 🧡", "Стася", "Оляша"]
        for name in test_names:
            with self.subTest(name=name):
